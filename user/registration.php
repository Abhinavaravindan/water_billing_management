...
$dao=new DataAccess();
$elements=array(
        "fname"=>"","lname"=>"","cid"=>"","email"=>"","phone"=>"","password"=>"","cpassword"=>"");


$form=new FormAssist($elements,$_POST);
//$file=new FileUpload();
$labels=array('fname'=>"First Name","lname"=>"Last Name","cid"=>"consumer id","email"=>"Email Id","ph"=>"Phone Number","password"=>"Password","cpassword"=>"Confirm Password");
...
$rules=array(
    ...
    "cid"=>array("required"=>true,"minlength"=>1,"maxlength"=>30,"integeronly"=>true),
                ...
                <div class="card-body">
					...
					<p><?php if(isset($msg)) echo $msg; ?></p>
                        <div class="input-group">
                         ...
                         <div class="input-group">
                             <?= $form->textBox('cid',array("placeholder"=>"Consumer ID")); ?>
                           <span class="valErr"><?= $validator->error('cid'); ?></span>
                        ...
                        <div class="p-t-10">
                            <button class="btn btn--pill btn--green" name="register" type="submit">Register</button>
                                ...
                                <div class="p-t-10">
                              <button class="btn btn--pill btn--green" name="home" type="submit">login</button>
                        </div>
                    </form>
                </div>
            </div>
